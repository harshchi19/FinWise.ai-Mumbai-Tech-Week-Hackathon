...
const ProfilePage = () => {
  ...
  const renderPersonalInfoSection = () => {
    return (
      <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="flex items-center">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent"
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-5">
              ...
              <select
                ...
                className="h-10 w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-transparent"
              >
        ...
        <div className="mt-8 bg-gradient-to-r from-primary-50 to-primary-50 dark:from-primary-900/20 dark:to-primary-900/20 rounded-xl p-6">
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="mt-6">
          ...
          <button className="mt-6 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors text-sm">
            Save Preferences
          </button>
        </div>
      </div>
  ...
  return (
    <div className="dark:from-gray-900 dark:to-gray-800 pr-2 overflow-y-scroll">
                    ...
                    className={`
                      ...
                      ${
                        activeSection === item.section
                          ? "bg-primary-200 dark:bg-primary-900/50 text-primary-600 dark:text-primary-300 shadow-sm"
